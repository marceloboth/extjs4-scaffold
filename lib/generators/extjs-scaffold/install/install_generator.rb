require 'generators/extjs-scaffold'
...
module Extjs4Scaffold
  module Generators
    class InstallGenerator < Rails::Generators::Base
      ...
      def css_and_images
        copy_file 'extjs-scaffold.css.scss', 'app/assets/stylesheets/extjs-scaffold.css.scss'
        directory 'images', 'app/assets/images/extjs-scaffold'
        copy_file 'images/tick.png', 'public/images/extjs-scaffold/tick.png'
      end
